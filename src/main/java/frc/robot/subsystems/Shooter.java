...
public class Shooter extends SubsystemBase {
  ...
  CANSparkMax shooter = new CANSparkMax(ShooterConstants.SHOOTER_MOTOR_PORT, CANSparkMax.MotorType.kBrushless);

  public Shooter() {
    shooter.setInverted(ShooterConstants.SHOOTER_INVERTED);
  }
