...
// This is the auton for the Barrel Racing Path

// NOTE:  Consider using this command inline, rather than writing a subclass.  For more
// information, see:
// https://docs.wpilib.org/en/stable/docs/software/commandbased/convenience-features.html
public class DoABarrelRoll extends SequentialCommandGroup {
  /** Creates a new Barrel Racing. */
  public DoABarrelRoll(DriveTrain driveTrain) {
